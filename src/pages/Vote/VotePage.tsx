...
import { AVERAGE_BLOCK_TIME_IN_SECS, COMMON_CONTRACT_NAMES, COINVEX, ZERO_ADDRESS } from '../../constants'
      ...
      <ProposalInfo gap="lg" justify="start">
        ...
        <AutoColumn gap="10px" style={{ width: '100%' }}>
          ...
          {proposalData && proposalData.status === ProposalState.Active && !showVotingButtons && (
            <GreyCard>
              <TYPE.black>
                Only COINVEX votes that were self delegated or delegated to another address before block{' '}
