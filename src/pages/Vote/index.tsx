...
import { COINVEX, ZERO_ADDRESS } from '../../constants'
import { ChainId, JSBI, TokenAmount } from '@coinvestingdefi/dex-sdk'
...
export default function Vote() {
  ...
  const uniBalance: TokenAmount | undefined = useTokenBalance(account ?? undefined, chainId ? COINVEX[chainId] : undefined)
  ...
  return (
    <PageWrapper gap="lg" justify="center">
      ...
      <TopSection gap="md">
        <VoteCard>
          ...
          <CardSection>
            <AutoColumn gap="md">
              <RowBetween>
                <TYPE.white fontWeight={600}>Coinvesting DeFi Governance</TYPE.white>
              </RowBetween>
              <RowBetween>
                <TYPE.white fontSize={14}>
                  COINVEX tokens represent voting shares in Coinvesting DeFi governance. You can vote on each proposal yourself or
              ...
              {/* <ExternalLink
                ...
                target="_blank"
              >
                <TYPE.white fontSize={14}>Read more about Coinvesting DeFi governance</TYPE.white>
              </ExternalLink> */}
            </AutoColumn>
          </CardSection>
          <CardBGImage />
      ...
      <TYPE.subHeader color="text3">
        A minimum threshhold of 1% of the total COINVEX supply is required to submit proposals
      </TYPE.subHeader>
    </PageWrapper>
  )
}
