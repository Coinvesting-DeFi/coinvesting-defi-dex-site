import { JSBI, Token, TokenAmount } from '@coinvestingdefi/dex-sdk'
...
export function computeUniCirculation(
  ...
  const total = new TokenAmount(coinvex, JSBI.multiply(wholeAmount, JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(18))))
