import { COINVEX, PRELOADED_PROPOSALS } from './../../constants/index'
...
export function useUserVotes(): TokenAmount | undefined {
  ...
  return votes && coinvex ? new TokenAmount(coinvex, votes) : undefined
}
...
export function useDelegateCallback(): (delegatee: string | undefined) => undefined | Promise<string> {
  ...
  return useCallback(
    (delegatee: string | undefined) => {
      ...
      if (!uniContract) throw new Error('No COINVEX Contract!')
